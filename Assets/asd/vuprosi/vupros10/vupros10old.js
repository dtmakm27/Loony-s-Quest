...
public var c : GameObject;
	function OnGUI () {
		...
		windowRect = GUI.Window (0, windowRect, DoMyWindow, "Въпрос#10");
	}
	...
	function DoMyWindow (windowID : int) {
		...
		GUILayout.Space(spacing);
		if(GUILayout.Button("променлива от тип цяло число", GUILayout.Height(buttonHeight))|| Input.GetKeyUp ("c")) {
