...
using System.IO;
public class urocs2 : MonoBehaviour {
	public GUIStyle st1;
	public GUIStyle st2;
	public GUIStyle st3;
	string debuginfo;
	public GUIStyle st4;
	private debuge2 myLight;
	bool greshka = true;
	...
	void Start () {
		myLight = GetComponent<debuge2>();

		kodirane = System.IO.File.ReadAllText (@"C:\Loony's quest\tasks\ur3\ur3.cpp");
		...
		System.IO.File.Delete(@"C:\Loony's quest\tasks\ur3\ur3.001.txt");
		System.IO.File.Delete(@"C:\Loony's quest\tasks\ur3\ur3.002.txt");
	...
	void Sravni () {
		if (GUI.Button (new Rect (Screen.width / 1.9f, Screen.height / 1.19f, Screen.width / 8f, Screen.height / 3f), q, st1)) {
			...
			Process proc = null;
			try {
				string targetDir = string.Format (@"C:\Loony's quest\tasks\ur3");
				proc = new Process ();
			...
			string otgovor1 = System.IO.File.ReadAllText (@"C:\Loony's quest\tasks\ur3\ur3.001.sol");
			string izhod1 = System.IO.File.ReadAllText (@"C:\Loony's quest\tasks\ur3\ur3.001.txt");
	...
	void OnGUI(){ 
		...
		if (GUI.Button (new Rect (Screen.width/1.5f,Screen.height/1.275f,Screen.width/5f,Screen.height/3),d,st1)) {
			System.IO.File.WriteAllText (@"C:\Loony's quest\tasks\ur3\ur3.cpp", kodirane);
			System.IO.File.Delete(@"C:\Loony's quest\tasks\ur3\ur3.001.txt");
			System.IO.File.Delete(@"C:\Loony's quest\tasks\ur3\ur3.002.txt");
			//greshka = false;
			System.IO.File.Delete (@"C:\Loony's quest\tasks\ur3\a.txt");
			...
			debuginfo = System.IO.File.ReadAllText (@"C:\Loony's quest\tasks\ur3\a.txt");
